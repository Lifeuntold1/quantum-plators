    ...
    return (
      <div className="w-full relative rounded-3xl overflow-hidden bg-gradient-to-br from-surface via-ink-950 to-ink-900 border border-gold-500/30 shadow-[0_20px_60px_-15px_rgba(201,162,75,0.2)] min-h-[560px] sm:min-h-[640px] flex items-center justify-center p-8 sm:p-16 transition-all duration-700 hover:border-gold-400/50">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          <p className="mt-6 text-lg sm:text-2xl font-body text-gray-200 max-w-2xl font-light leading-relaxed drop-shadow">
            Welcome to the official digital legacy platform, live directory, and historical celebration of our journey.
          </p>
          ...
          <div className="mt-16 pt-8 border-t border-white/[0.1] grid grid-cols-3 gap-8 w-full max-w-2xl text-center">
            ...
            <div className="p-3 rounded-2xl bg-white/[0.02] border border-white/[0.05]">
              ...
              <div className="text-[11px] font-mono text-gray-300 uppercase tracking-wider mt-1 font-medium">Live Data Vault</div>
            </div>
            <div className="p-3 rounded-2xl bg-white/[0.02] border border-white/[0.05]">
  ...
  return (
    <div className="w-full relative rounded-3xl overflow-hidden bg-ink-950 border border-gold-500/30 shadow-[0_20px_60px_-15px_rgba(201,162,75,0.25)] min-h-[560px] sm:min-h-[640px]">
      ...
      <div className="relative z-20 max-w-4xl mx-auto text-center flex flex-col items-center justify-end h-full min-h-[560px] sm:min-h-[640px] p-8 sm:p-16">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-ink-950/90 border border-gold-500/50 text-gold-300 font-mono text-xs tracking-widest uppercase mb-6 backdrop-blur-md shadow-gold-glow">
          <span className="w-2 h-2 rounded-full bg-gold-400 animate-pulse"></span>
          <span>Theme: Quantum Leap • Physics Class of 2024</span>
        </div>
        <h1 className="font-display text-5xl sm:text-7xl lg:text-8xl font-bold tracking-tight text-[#F8F8FA] drop-shadow-lg">
          Quantum Plators <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold-200 via-gold-400 to-amber-200">'24</span>
        </h1>
        <p className="mt-4 text-base sm:text-2xl font-body text-gray-200 max-w-2xl font-light drop-shadow">
          Welcome to the official digital legacy platform, class directory, and historical vault for the Department of Physics, University of Jos.
        </p>
